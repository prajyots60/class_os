      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-bold tracking-tight text-[hsl(var(--foreground))]">Students Workspace</h1>
            {totalCount > 0 && (
        ...
        {canCreate && (
          <Button onClick={onAddStudentClick} data-testid="add-student-button" className="gap-2 shrink-0 self-start sm:self-auto min-h-[44px]">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {onAdmissionStatusFilterChange && (
              <select
                ...
                className="rounded-md border border-[hsl(var(--input))] bg-[hsl(var(--background))] px-3 py-1.5 text-xs text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring))]"
                value={admissionStatusFilter || 'all'}
