export { InstituteSettingsContent } from './components/institute-settings-content';
...
export type { InstituteSettingsFormData } from './schemas/institute-settings-form-schema';
export type { InstituteSettingsDTO, ApiSettingsResponse } from './types/institute-settings.types';
