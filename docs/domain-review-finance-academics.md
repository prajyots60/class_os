...
**Reason:** "Fee Plan" describes an amount. "Billing Plan" describes _how invoices are generated_ — the schedule, the rules, the agreement. The name change makes the responsibility explicit.
...
_(See also Q10 — Timetable is superseded by Schedule.)_
...
| ---------- | ------------------------------------------------ | -------------------------------- |
| `Schedule` | Recurring rule — what _should_ happen every week | Mon/Wed/Fri 7–8 AM Physics       |
| `Session`  | Generated instance — what _actually_ happened    | Monday Aug 10, 7–8 AM, completed |
...
_Domain Review — Finance & Academics: Frozen_  
_Next: Communication & Notifications Domain Review_
